...
describe('address test', function() {
    ...
    it('renders state of zip after click', () => {
        wrapper.instance().setAddress(1);
    ...
    it('renders and displays the default phone from FakeData', () => {
        expect(wrapper.state().address.phone).toEqual('202-224-2621');
    });

    it('renders state of phone after click', () => {
        wrapper.instance().setAddress(1);
        expect(wrapper.state().address.phone).toEqual('202-225-4876');
    });

    it('renders and displays the default website', () => {
        expect(addressProp(wrapper).website).toEqual('unknown');
    });

    it('renders and displays the default website from FakeData', () => {
        expect(wrapper.state().address.website).toEqual(
            'https://www.murray.senate.gov/public'
        );
    });

    it('renders state of website after click', () => {
        wrapper.instance().setAddress(1);
        expect(wrapper.state().address.website).toEqual(
